 ...
 * @author b0rN_pR0
 */
public class searchresult_1 extends javax.swing.JFrame {
Connection con;
Statement stmt;
ResultSet rs;
    /**
     * Creates new form searchresult_1
     */
    public searchresult_1() {
        initComponents();
        DoConnect();
    ...
    try{
     ...
     while(rs.next()){
         if(searchbyserial.t.equals(rs.getString("SEARCHSERIAL"))) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchresult_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchresult_1().setVisible(true);
            }
        });
    }
