...
public class DRESSDATABASE extends javax.swing.JFrame {
Connection con;
Statement stmt;
ResultSet rs;
    ...
    private void initComponents() {
        ...
        btnprevious.setBackground(new java.awt.Color(255, 102, 102));
     ...
     try {
      ...
      int id_col = rs.getInt("serialno");
         ...
         textcolor.setText(color);
          ...
          rs.previous( );
         JOptionPane.showMessageDialog(DRESSDATABASE.this, "End of File");
          }
          }
         catch (SQLException err) {
         JOptionPane.showMessageDialog(DRESSDATABASE.this, err.getMessage());
}        // TODO add your handling code here:
    ...
    private void btnpreviousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpreviousActionPerformed
     try {
         ...
         rs.next( );
         JOptionPane.showMessageDialog(DRESSDATABASE.this, "Start of file");
          }
          }
         catch (SQLException err) {
         JOptionPane.showMessageDialog(DRESSDATABASE.this, err.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DRESSDATABASE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DRESSDATABASE().setVisible(true);
            }
        });
    }
